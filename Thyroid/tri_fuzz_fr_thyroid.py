# -*- coding: utf-8 -*-
"""
Created on Wed May 16 00:57:13 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon May 14 20:18:17 2018
...
result_col = dataset[['col1']]
data = dataset[['col2','col3','col4','col5','col6']].apply(lambda x: (x - x.min()) / (x.max() - x.min()))
dataset = pd.concat([data,result_col],axis=1)

name1 = ['col2','col3','col4','col5','col6']
result = 'col1'
