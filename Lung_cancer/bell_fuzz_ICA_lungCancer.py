...
#np.random.seed(2)
#learning_rate = 0.04080047812744279
...
testres = test[[result]].replace([0,1,2], [0,1,2])
testres['Prediction'] = yp
testres['Prediction'] = testres['Prediction'].replace([0,1,2], [0,1,2])
