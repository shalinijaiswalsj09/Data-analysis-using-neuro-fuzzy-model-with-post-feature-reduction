...
data['attribute5']= pd.to_numeric(data['attribute5'], errors='coerce')

data['attribute39']= pd.to_numeric(data['attribute39'], errors='coerce')
...
train = df[df.train == 1]
train['attribute2'].fillna(0, inplace=True)
train = train.drop('train', axis=1).sample(frac=1)

test = df[df.train == 0]
test['attribute2'].fillna(0, inplace=True)
...
#np.random.seed(2)
#learning_rate = 0.05
learning_rate = np.random.uniform(0,0.9)
print(learning_rate)
