...
#final_df.columns=['SepalLengthCm0','SepalLengthCm1','SepalLengthCm2','SepalWidthCm0','SepalWidthCm1','SepalWidthCm2','PetalLengthCm0','PetalLengthCm1','PetalLengthCm2','PetalWidthCm0','PetalWidthCm1','PetalWidthCm2','Species']

'''

x = [i for i in range(0,150)]
ax = plt.subplot()
p0, =plt.plot(x,dataset1['SepalLengthCm'], '-', marker='o', color='black', label= 'Actual data', lw=2)
p1, =plt.plot(x,final_df['SepalLengthCm0'], ':', marker='*',color='crimson', label= 'Fuzzified value wrt Class-0', lw=2)
p2, =plt.plot(x,final_df['SepalLengthCm1'], '--',marker='x', color='maroon', label= 'Fuzzified value wrt Class-1', lw=1)
p3, =plt.plot(x,final_df['SepalLengthCm2'],'-',marker='+', color='blue', label= 'Fuzzified value wrt Class- 2', lw=1)
plt.xlabel("Sepal Length Attribute") 
plt.xlim(xmax=150)
plt.ylim(ymax=11.5) 
plt.ylim(ymin=-0.5)
plt.ylabel("Value")
