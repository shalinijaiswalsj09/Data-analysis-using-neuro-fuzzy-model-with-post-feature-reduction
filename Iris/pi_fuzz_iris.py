...
result_col = dataset1[['Species']]
data = dataset1[['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm']].apply(lambda x: (x - x.min()) / (x.max() - x.min()))
...
testres = test[[result]].replace([0,1,2], ['Iris-setosa','Iris-versicolor','Iris-virginica'])
