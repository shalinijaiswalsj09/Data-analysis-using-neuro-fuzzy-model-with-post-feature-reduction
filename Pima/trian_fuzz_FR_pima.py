...
result_col = dataset[['Outcome']]
data = dataset[['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness','Insulin','BMI','DiabetesPedigreeFunction','Age']].apply(lambda x: (x - x.min()) / (x.max() - x.min()))
...
#learning_rate = 0.025 
#np.random.seed(5)
learning_rate =0.00311369109933219
